...
from tot.evaluation.metric_utils import calculate_averaged_metrics_per_experiment, calculate_metrics_by_ID_for_forecast_step
from tot.models.models_neuralprophet import NeuralProphetModel
from tot.models.models_simple import RandomForestModel, NbeatsModel
...
df = generate_one_shape_season_data(series_length=SERIES_LENGTH, date_rng=DATE_RNG, n_ts_groups=[10, 1], offset_per_group=[0, 0], amplitude_per_group=[5, 50])
