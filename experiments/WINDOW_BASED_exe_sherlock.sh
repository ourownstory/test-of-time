...
#'python3 EXP_SYN_DATA.py --data_func gen_cancel_shape_ar_outlier_0p1 --model RNNModel --params RNN_wb --data_n_ts_groups "+10,1" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --gen_func "gen_model_and_params_none'
