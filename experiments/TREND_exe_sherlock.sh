...
### NP_FNN_sw
commands_NP_FNN_sw=(
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "5,5" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,10" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "10,1" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,10" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "0,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "10,1" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "0,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "2,2,2,2" --data_offset_per_group "10,10, 1, 1" --data_amplitude_per_group "10,10,1,1" --data_trend_gradient_per_group "10,0,10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,1,2,2" --data_offset_per_group "10,10, 1, 1" --data_amplitude_per_group "10,10,1,1" --data_trend_gradient_per_group "1,0,1,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "5,5" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,10" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "10,1" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,10" --data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "0,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "10,1"--data_offset_per_group "10,1" --data_amplitude_per_group "10,1" --data_trend_gradient_per_group "0,1" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "2,2,2,2" --data_offset_per_group "10,10, 1, 1" --data_amplitude_per_group "10,10,1,1" --data_trend_gradient_per_group "10,0,10,0" --gen_func "gen_model_and_params_scalers_reweighting"'
'python3 EXP_SYN_DATA.py --data_func gen_one_shape_ar_trend_cp --model NeuralProphetModel --params NP_FNN_sw --data_n_ts_groups "1,1,2,2" --data_offset_per_group "10,10, 1, 1" --data_amplitude_per_group "10,10,1,1" --data_trend_gradient_per_group "1,0,1,0" --gen_func "gen_model_and_params_scalers_reweighting"'
)
